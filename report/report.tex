...
independently. The evaluation confirms that all four goals hold in practice:
the required requests succeed within tolerance, and invalid or out-of-range
requests never move the robot.
